...
class HTML_Timeline {
    ...
    function settings($option, &$row) {
        ...
        <form action="index.php" method="post" name="adminForm">
                        ...
                        <table class="adminlist">
                            <thead>
                                <tr>
                                    ...
                                    <th nowrap="nowrap" class="title"><?php echo JText::_('Name'); ?></th>
                                    <th nowrap="nowrap"><?php echo JText::_('Published'); ?></th>
                                    <th nowrap="nowrap"><?php echo JText::_('Events'); ?></th>
                                    <th nowrap="nowrap"><?php echo JText::_('Modified'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
            ...
            <?php echo $published; ?>
                                        ...
                                        <td align="center">
                                            <a href="<?php echo $events_link; ?>" title="<?php echo JText::_('Events'); ?>">
    ...
    function category_list($option, &$rows) {
                        ...
                        <table class="adminlist">
                            <thead>
                                <tr>
                                    ...
                                    <th nowrap="nowrap"><?php echo JText::_('End Date'); ?></th>
                                    <th nowrap="nowrap">
                                        <a href="<?php echo $calendarSortLink; ?>">
                                            <?php echo JText::_('Timeline'); ?>
                                        </a>
                                    </th>
                                    <th nowrap="nowrap"><?php echo JText::_('Modified'); ?></th>
                                </tr>
                    ...
                    <form action="index.php" method="post" name="adminForm">
                        ...
                        <table class="adminlist">
                            <thead>
                                <tr>
                                    <th width="20"><input type="checkbox" name="toggle" value=""  onclick="checkAll(<?php echo count($rows); ?>);" /></th>
                                    <th nowrap="nowrap" class="name"><?php echo JText::_('Name'); ?></th>
                                    <th nowrap="nowrap"><?php echo JText::_('Timeline'); ?></th>
                                </tr>
                            </thead>
                            <tbody>
                    <?php
                        ...
                        <div class="col100" id="editForm">
                            <fieldset class="adminform">
                                <table class="admintable">
                                    <tbody>
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Timeline name'); ?>">
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Is the timeline published or not'); ?>">
        ...
        <?php echo JHTML::_('select.booleanlist', 'published', '', $row->published); ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Access Level for Timeline'); ?>">
                                                <label for="access"><?php echo JText::_('Access level'); ?></label>
                                            </td>
                                            <td>
                                                <!-- TODO: Get the group list from JHTML -->
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Timeline description'); ?>">
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Date format for the timeline. The default value is iso8601'); ?>">
                                                <label for="datetime_format"><?php echo JText::_('Date Format'); ?></label>
                                            </td>
                                            <td>
        <?php
        ...
        ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Timeline theme. Default value is ClassicTheme'); ?>">
                                                <label for="theme"><?php echo JText::_('Theme'); ?></label>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Default value is week'); ?>">
                                                <label for="interval_unit"><?php echo JText::_('Interval Unit'); ?></label>
                                            </td>
                                            <td>
                                                <select id="interval_unit" name="interval_unit">
                                                    <option name="0" value="0" <?php if ($row->interval_unit == '0') echo "selected='selected'"; ?>><?php echo JText::_('Millisecond'); ?></option>
                                                    <option name="1" value="1" <?php if ($row->interval_unit == '1') echo "selected='selected'"; ?>><?php echo JText::_('Second'); ?></option>
                                                    <option name="2" value="2" <?php if ($row->interval_unit == '2') echo "selected='selected'"; ?>><?php echo JText::_('Minute'); ?></option>
                                                    <option name="3" value="3" <?php if ($row->interval_unit == '3') echo "selected='selected'"; ?>><?php echo JText::_('Hour'); ?></option>
                                                    <option name="4" value="4" <?php if ($row->interval_unit == '4') echo "selected='selected'"; ?>><?php echo JText::_('Day'); ?></option>
                                                    <option name="5" value="5" <?php if ($row->interval_unit == '5' || !$row->interval_unit) echo "selected='selected'"; ?> ><?php echo JText::_('Week'); ?></option>
                                                    <option name="6" value="6" <?php if ($row->interval_unit == '6') echo "selected='selected'"; ?> ><?php echo JText::_('Month'); ?></option>
                                                    <option name="7" value="7" <?php if ($row->interval_unit == '7') echo "selected='selected'"; ?> ><?php echo JText::_('Year'); ?></option>
                                                    <option name="8" value="8" <?php if ($row->interval_unit == '8') echo "selected='selected'"; ?> ><?php echo JText::_('Decade'); ?></option>
                                                    <option name="9" value="9" <?php if ($row->interval_unit == '9') echo "selected='selected'"; ?> ><?php echo JText::_('Century'); ?></option>
                                                    <option name="10" value="10" <?php if ($row->interval_unit == '10') echo "selected='selected'"; ?> ><?php echo JText::_('Millennium'); ?></option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Interval width in pixels. Default value is 100'); ?>">
                                                <label for="interval_pixel"><?php echo JText::_('Interval width (px)'); ?></label>
                                            </td>
                                            <td>
        <?php
        ...
        ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Start date for timeline'); ?>">
        ...
        ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Scroll start date for timeline'); ?>">
                                                <label for="scroll_start_date"><?php echo JText::_('Scroll Start Date'); ?></label>
                                            </td>
                                            <td>
                                                <?php
        ...
        ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Scroll end date for timeline'); ?>">
                                                <label for="scroll_end_date"><?php echo JText::_('Scroll End Date'); ?></label>
                                            </td>
                                            <td>
                                                <?php
        ...
        ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Timeline container width. Example: 100 or 100%'); ?>">
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Direction of timeline. This is for future implementations'); ?>">
                                                <label for="direction"><?php echo JText::_('Direction'); ?></label>
                                            </td>
                                            <td>
                                                <select id="direction" name="direction">
                                                    <option name="VERTICAL" value="VERTICAL" <?php if ($row->direction == 'VERTICAL') echo "selected='selected'"; ?> ><?php echo JText::_('Vertical'); ?></option>
                                                    <option name="HORIZONTAL" value="HORIZONTAL" <?php if ($row->direction == 'HORIZONTAL' || !$row->direction) echo "selected='selected'"; ?> ><?php echo JText::_('Horizontal'); ?></option>
                                                </select>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Event bubble width in pixels'); ?>">
                                                <label for="bubble_width"><?php echo JText::_('Bubble Width'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Event bubble height in pixels'); ?>">
                                                <label for="bubble_height"><?php echo JText::_('Bubble Height'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Event Image. Either external image or located in JOOMLA_DIR folder by default. Example: blue-circle.png - this will display image JOOMLA_DIR/components/com_intotimeline/img/blue-circle.png'); ?> ">
                                                <label for="event_img"><?php echo JText::_('Event Image'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Event Line Color in hex'); ?>">
                                                <label for="event_line_color"><?php echo JText::_('Event Line Color'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Imprecise Event Color in hex'); ?>">
                                                <label for="event_imprecise_color"><?php echo JText::_('Imprecise Event Color'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Opacity in %. Values between 0..100'); ?>">
                                                <label for="event_imprecise_opacity"><?php echo JText::_('Imprecise Event Opacity'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Color in hex'); ?>">
                                                <label for="event_duration_color"><?php echo JText::_('Event Duration Color'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Opacity in %. Values between 0..100'); ?>">
                                                <label for="event_duration_opacity"><?php echo JText::_('Event Duration Opacity'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Color in hex'); ?>">
                                                <label for="event_duration_imprecise_color"><?php echo JText::_('Imprecise Event Duration Color'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } else { ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Opacity in %. Values between 0..100'); ?>">
                                                <label for="event_duration_imprecise_opacity"><?php echo JText::_('Imprecise Event Duration Opacity'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
    ...
    function category_edit($option, &$row) {
                        ...
                        <div class="col100" id="editForm">
                            <fieldset class="adminform">
                                <table class="admintable">
                                    <tbody>
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Category name'); ?>">
                                                <label for="name"><?php echo JText::_('Name'); ?></label>
                                            </td>
                                            <td>
                                                <input class="inputbox" type="text" name="name" id="name" size="40" maxlength="255" value="<?php echo $row->name; ?>" />
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Is the category enabled?'); ?>">
                                                <label for="enabled"><?php echo JText::_('Enable'); ?></label>
                                            </td>
                                            <td>
        ...
        <?php } ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Event Text Color'); ?>">
                                                <label for="event_text_color"><?php echo JText::_('Event Text Color'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
        ...
        <?php } ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Color in hex'); ?>">
                                                <label for="event_duration_color"><?php echo JText::_('Imprecise Event Color'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
                                                    <input class="inputbox" type="text" name="event_duration_imprecise_color" id="event_duration_imprecise_color" size="40" maxlength="255" value="<?php echo $row->event_duration_imprecise_color; ?>" />
        ...
        <?php } ?>
                                        ...
                                        <tr>
                                            <td width="20%" class="key" title="<?php echo JText::_('Opacity in %. Values between 0..100'); ?>">
                                                <label for="event_text_color"><?php echo JText::_('Imprecise Event Opacity'); ?></label>
                                            </td>
                                            <td>
        <?php if ($row->id) { ?>
                                                    <input class="inputbox" type="text" name="event_duration_imprecise_opacity" id="event_duration_imprecise_opacity" size="40" maxlength="255" value="<?php echo $row->event_duration_imprecise_opacity; ?>" />
    ...
    function event_edit($option, &$row) {
        ...
        if (count($timeline_rows) > 0) {
                            ...
                            <div class="col100" id="editForm">
                                <fieldset class="adminform">
                                    <table class="admintable">
                                        <tbody>
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Event title'); ?>">
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Timeline to which event will be bound'); ?>">
                                                    <label for="timeline_id"><?php echo JText::_('Timeline'); ?></label>
                                                </td>
                                                <td>
            ...
            ?>
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Category to which event will be bound'); ?>">
            ...
            foreach ($category_rows as $category_row) {
                ?>
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Event description to be shown inside the popup bubble.'); ?>">
                                                    <label for="description"><?php echo JText::_('Description'); ?></label>
                                                </td>
                                                <td>
                                                    <textarea class="inputbox" type="text" name="description" id="description" cols="28" rows="4"><?php echo $row->description; ?></textarea>
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Start date for event'); ?>">
                                                    <label for="start_date"><?php echo JText::_('Start Date'); ?></label>
                                                </td>
                                                <td>
                                                        <?php
            ...
            ?>
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('End date for event'); ?>">
                                            ...
                                            <tr>
                                                <td title="Imprecise" colspan="2">
                                                    <span style="cursor:pointer;" onclick="var elm = document.getElementById('imprecise_container');
                                if (elm.style.display == 'none') {
                                    elm.style.display = '';
                                } else {
                                    elm.style.display = 'none';
                                }"><?php echo JText::_('Are event dates imprecise?'); ?></span>
                                                </td>
                                            </tr>
                                            <tr style="display:none" id="imprecise_container">
                                                <td title="Imprecise" colspan="2" style="padding:0">
                                                    <table>
                                                        <tr>
                                                            <td width="20%" class="key" title="<?php echo JText::_('Latest start date for event'); ?>">
                                                                <label for="latest_start"><?php echo JText::_('Latest Start Date'); ?></label>
                                                            </td>
                                                            <td>
            <?php
            ...
            ?>
                                                        ...
                                                        <tr>
                                                            <td width="20%" class="key" title="<?php echo JText::_('Earliest end date for event'); ?>">
                                                                <label for="earliest_end"><?php echo JText::_('Earliest End Date'); ?></label>
                                                            </td>
                                                            <td>
                                                                <?php
            ...
            ?>
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Icon'); ?>">
                                                    <label for="image"><?php echo JText::_('Icon'); ?></label>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Link to be shown in the popup bubble'); ?>">
                                                    <label for="image"><?php echo JText::_('Link'); ?></label>
                                                </td>
                                                <td>
                            ...
                            <div class="col100" id="editForm">
                                <fieldset class="adminform">
                                    <table class="admintable">
                                        <tbody>
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Band title'); ?>">
                                                    <label for="name"><?php echo JText::_('Name'); ?></label>
                                                </td>
                                                <td>
                                                    <input class="inputbox" type="text" name="name" id="name" size="40" maxlength="255" value="<?php echo $row->name; ?>" />
                                            ...
                                            <tr>
                                                <td width="20%" class="key" title="<?php echo JText::_('Timeline to which band will belong'); ?>">
                                                    <label for="timeline_id"><?php echo JText::_('Timeline'); ?></label>
                                                </td>
                                                <td>
                                                    <select id="timeline_id" name="timeline_id">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <select id="interval_unit" name="interval_unit">
                                                        ...
                                                        <option name="8" value="8" <?php if ($row->interval_unit == '8') echo "selected='selected'"; ?> ><?php echo JText::_('Decade'); ?></option>
                                                        <option name="9" value="9" <?php if ($row->interval_unit == '9') echo "selected='selected'"; ?> ><?php echo JText::_('Century'); ?></option>
                                                        <option name="10" value="10" <?php if ($row->interval_unit == '10') echo "selected='selected'"; ?> ><?php echo JText::_('Millemium'); ?></option>
                                                    </select>
                                                </td>
                                            </tr>
                                            <tr>
    ...
    function setTimelineToolbar($id) {
        ...
        JToolBarHelper::title(JText::_($newEdit . ' Timeline'), 'addedit.png');
    ...
    function setCategoryToolbar($id) {
        ...
        JToolBarHelper::title(JText::_($newEdit . ' Category'), 'addedit.png');
    ...
    function setTimelineFromCSVToolbar() {
        JToolBarHelper::title(JText::_('New Timeline'), 'addedit.png');
    ...
    function setTimelinesListToolbar() {
        JToolBarHelper::title(JText::_('Timelines'), 'categories.png');
    ...
    function setEventsListToolbar() {
        JToolBarHelper::title(JText::_('Events'), 'categories.png');
        $db = & JFactory::getDBO();
        $db->setQuery("SELECT id, name from #__tl_timeline");
        $timeline_rows = $db->loadObjectList();
        if (count($timeline_rows) > 0) {
    ...
    function setBandListToolbar() {
        JToolBarHelper::title(JText::_('Bands'), 'categories.png');
        $db = & JFactory::getDBO();
        $db->setQuery("SELECT id, name from #__tl_timeline");
        $timeline_rows = $db->loadObjectList();
        if (count($timeline_rows) > 0) {
    ...
    function includeResources() {
        ...
        $document->addScript(JURI::root() . $componentPath . 'js/into_timeline.js');
        $document->addStyleSheet(JURI::root() . $componentPath . 'css/into_timeline.css');
    }
